...
<div class="page-banner">
  <div class="page-banner__bg-image" style="background-image: url(<?php echo get_theme_file_uri('/assets/images/library-hero.jpg') ?>);"></div>
    <div class="page-banner__content container t-center c-white">
      ...
      <a href="#" class="btn btn--large b tn--blue">Find Your Major</a>
    </div>
  </div>
  ...
  <div class="full-width-split group">
          ...
          while($homepageEvents->have_posts()) {
            ...
            <div class="event-summary">
              <a class="event-summary__date t-center" href="#">
                <span cla ss="event-summary__month"><?php 
    ...
    <div class="full-width-split__two">
      <div class="full-width-split__inner">
        ...
        <?php
          // custom query defaul post wordpress
        ...
        <?php 
          // when custom query wordpress should reset after use it
          } wp_reset_postdata();
        ?>
