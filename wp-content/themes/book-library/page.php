<?php 
  ...
  while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
      <?php
      // get id from children of page
      $parentPage = wp_get_post_parent_id(get_the_ID());
        if ($parentPage) { ?>
          <div class="metabox metabox--position-up metabox--with-home-link">
            <p><a class="metabox__blog-home-link" href="<?php echo get_permalink($parentPage) ?>"><i class="fa fa-home" aria-hidden="true"></i><?php echo get_the_title(($parentPage)) ?></a> <span class="metabox__main"><?php echo the_title(); ?></span></p>
          </div>
        <?php }
      ?>
      <?php 
